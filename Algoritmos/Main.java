...
public class Main {
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            // Crear un contenedor de rectángulos con capacidad máxima n
            ...
            // Cada vez que se crea un rectángulo, se agrega al contenedor
            ...
            // Muestra el contenido del contenedor al finalizar
